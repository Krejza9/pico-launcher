...
bool RomBrowserStateMachine::FireDirect(RomBrowserStateTrigger trigger)
{
    ...
    if (StateMachineTriggerChecker(_curState, trigger)
        ...
        .In(RomBrowserState::Browser)
            ...
            .Trigger(RomBrowserStateTrigger::ShowFileActionMenu).GoesTo(RomBrowserState::FileActionMenu)
        ...
        .In(RomBrowserState::FileActionMenu)
            .Trigger(RomBrowserStateTrigger::HideFileActionMenu).GoesTo(RomBrowserState::Browser)
        .Check(newState))
    {
